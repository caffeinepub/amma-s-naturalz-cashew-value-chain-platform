  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        gold: "0 4px 20px -2px oklch(0.78 0.16 75 / 30%)",
        forest: "0 4px 20px -2px oklch(0.28 0.08 155 / 25%)",
        card: "0 2px 16px oklch(0.22 0.04 50 / 8%), 0 1px 4px oklch(0.22 0.04 50 / 5%)",
        elevated: "0 8px 32px oklch(0.22 0.04 50 / 12%), 0 2px 8px oklch(0.22 0.04 50 / 8%)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
