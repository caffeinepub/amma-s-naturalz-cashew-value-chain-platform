...
export class Backend implements backendInterface {
    ...
    async getAllInvestorRegistrations(): Promise<Array<InvestorRegistration>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllInvestorRegistrations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMarketGuideLeadCaptures(): Promise<Array<MarketGuideLeadCapture>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMarketGuideLeadCaptures();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInvestorRegistration(arg0: bigint): Promise<InvestorRegistration> {
        if (this.processError) {
            try {
                const result = await this.actor.getInvestorRegistration(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMarketGuideLeadCapture(arg0: bigint): Promise<MarketGuideLeadCapture> {
        if (this.processError) {
            try {
                const result = await this.actor.getMarketGuideLeadCapture(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContactInquiry(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitInvestorRegistration(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInvestorRegistration(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitMarketGuideLeadCapture(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitMarketGuideLeadCapture(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
